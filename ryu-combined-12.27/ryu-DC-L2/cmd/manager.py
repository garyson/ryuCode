...
CONF.register_cli_opts([
    cfg.ListOpt('app-lists', default=["ryu.app.simple_switch_13",  "ryu.app.domain_controller"],
    ...
    cfg.IntOpt("domain_id", default=2,
               help="id of domain controller"),
    cfg.StrOpt("domain_wsgi_ip", default="10.108.90.203",
