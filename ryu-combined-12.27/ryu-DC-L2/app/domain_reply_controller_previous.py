        ...
        if length is not SINGLESWITCH:
            for i in switchList:
                ...
                if index == 0:
                    ...
                    outPortName = 'ge-1/1/' + str(outPortNo)
                    ...
                    match, mod = DC.pushMplsFlow(i, pushLabel, srcMac, dstMac, outPortNo, queueId, pathType)
                    ...
                    match, mod = DC.popMplsMacFlow(i, popLabel, outPortNo, queueId)
                    # queueQoSInstance.setQueueInUse(outPortNo, queueId)
            ...
            # match, mod = DC.noMplsMacFlow(i, srcIp, dstIp, outPortNo, queueId, pathType)
            match, mod = DC.noMplsFlow(i, srcMac, dstMac, outPortNo, queueId, pathType)
            # queueQoSInstance.setQueueInUse(outPortNo, queueId)
            if pathType == 'main':
                taskInstance.addMainMatchInfo(i, match)
                # taskInstance.setMainPortToQueueId(i, outPortNo, queueId)
